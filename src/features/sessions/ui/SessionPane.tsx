...
import { orchestrator, sameCheckout } from "../../orchestration/model/orchestration";
  ...
  return (
    ...
    >
      ...
      <div className="flex min-h-0 min-w-0 flex-1 flex-col">
        ...
        {dockComposer ? (
          <div className="mx-auto w-full max-w-3xl shrink-0">{composer}</div>
        ) : null}
      </div>
    </div>
  );
