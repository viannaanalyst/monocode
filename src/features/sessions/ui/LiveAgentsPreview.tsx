    ...
    >
      ...
      <div className="overflow-hidden rounded-lg bg-content/5">
        <div className="flex items-center gap-2 px-3.5 py-1.5">
          ...
          <span className="text-xs tabular-nums text-content/40">
            {agents.length}
          </span>
        </div>
        <div
        ...
        {extra > 0 ? (
          <button
            ...
            className="flex w-full items-center justify-center gap-1 px-2 py-1.5 text-xs text-content/50 hover:bg-content/8 hover:text-content"
          >
            {expanded ? (
