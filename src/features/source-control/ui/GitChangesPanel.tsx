      ...
      <div className="shrink-0 border-b border-stroke p-2">
        <div className="relative">
          <textarea
            ...
            placeholder={
              amend
                ? withShortcut("Amend message", `${MOD}↩ to amend`)
                : withShortcut("Message", `${MOD}↩ to commit`)
            }
        ...
        <div ref={menuRef} className="relative mt-1.5 flex">
          <button
            ...
            className={`flex h-7 min-w-0 flex-1 items-center justify-center gap-1.5 rounded-l-md text-sm font-medium ${
              canCommit
          ...
          {menuOpen ? (
            ...
            >
              ...
              <button
                ...
                className="flex h-7 w-full items-center justify-between gap-2 px-3 text-left text-sm text-content hover:bg-content/10"
              >
                {t("Amend Last Commit")}
