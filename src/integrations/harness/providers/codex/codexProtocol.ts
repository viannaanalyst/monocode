...
export function codexAuthRecoveryMessage(original: string): string {
  ...
  return [
    first,
    "",
    "One possible cause is another Codex process refreshing the shared login while this one still holds the old token. If so, sign in again only after stopping the others:",
