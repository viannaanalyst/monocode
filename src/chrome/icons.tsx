...
export const ArrowUpLong = wrap(ArrowUpBigIcon, "ArrowUpLong");
...
export const CoinsDollar = wrap(CoinsDollarIcon, "CoinsDollar");
...
export const History = wrap(HistoryIcon, "History");
...
export const Bookmark = wrap(Bookmark01Icon, "Bookmark");
