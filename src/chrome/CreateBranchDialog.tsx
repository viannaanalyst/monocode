      ...
      <form className="flex flex-col gap-4 p-4" onSubmit={submit}>
        <label className="flex flex-col gap-1.5">
          ...
          <input
            ...
            className="h-9 rounded-md border border-content/10 bg-content/5 px-2.5 font-mono text-sm text-content outline-none placeholder:font-sans placeholder:text-content/30 focus:border-content/25 disabled:opacity-50"
          />
        </label>

        {error ? (
          <p role="alert" className="text-xs leading-4 text-red-400/90">
            {error}
          </p>
        ) : null}
