...
export const PT_BR: Record<string, string> = {
  ...
  "{title} used": "{title} usado",
  "Updated just now": "Atualizado agora",
  "Rate-limit details": "Detalhes de limite",
  "Updated {minutes}m ago": "Atualizado há {minutes} min",
  "Updated {hours}h ago": "Atualizado há {hours} h",
  "{provider} usage": "Uso do {provider}",
  "{provider} usage details": "Detalhes de uso do {provider}",
  ...
  "Local project": "Projeto local",
  "Muted until resumed": "Mutado até retomar",
  "Muted until {time}": "Mutado até {time}",
  "Mute all notifications for": "Mutar todas as notificações por",
  "Mute all notifications until": "Mutar todas as notificações até",
  "Mute until then": "Mutar até então",
  "Choose a valid date and time.": "Escolha uma data e hora válidas.",
  "Choose a date and time in the future.":
    "Escolha uma data e hora no futuro.",
  "{count} project · {muted} muted": "{count} projeto · {muted} em mute",
  "{count} projects · {muted} muted": "{count} projetos · {muted} em mute",
  "{count} selected": "Selecionados: {count}",
  "Select {project}": "Selecionar {project}",
  ...
  "Your category choices apply when notifications resume. You can edit them while muted.":
    "Suas escolhas de categoria voltam a valer quando as notificações retomarem. Você pode editá-las durante o mute.",

  // Automations surface (upstream module)
  "Filter automations": "Filtrar automações",
  "No matching automations": "Nenhuma automação correspondente",
  Enable: "Ativar",
  "This run has no session yet": "Esta execução ainda não tem sessão",
  Succeeded: "Concluída",
  "Test run": "Execução de teste",
  Scheduled: "Agendada",
  "Removed folder": "Pasta removida",
  "Automation name": "Nome da automação",
  Reset: "Redefinir",
  "Pause automation": "Pausar automação",
  "Enable automation": "Ativar automação",
  Inactive: "Inativa",
  "Automation actions": "Ações da automação",
  "Automation view": "Visualização da automação",
  "Run history": "Histórico de execuções",
  "Choose automation trigger": "Escolher gatilho da automação",
  "Search triggers": "Buscar gatilhos",
  "No matching triggers": "Nenhum gatilho correspondente",
  "Tell the agent what to do when this automation runs…":
    "Diga ao agente o que fazer quando esta automação rodar…",

  // Worktrees
  "Add a project to manage its worktrees.": "Adicione um projeto para gerenciar seus worktrees.",
  "All uncommitted and untracked changes here are discarded.": "Todas as alterações não commitadas e não rastreadas aqui são descartadas.",
  "Also delete associated sessions": "Excluir também as sessões associadas",
  "An independent working copy of {cwd}. Existing uncommitted changes stay in their current working copy.": "Uma cópia de trabalho independente de {cwd}. Alterações não commitadas existentes permanecem na cópia de trabalho atual.",
  "Another working copy opens a new session.": "Outra cópia de trabalho abre uma nova sessão.",
  "Base branches": "Branches base",
  "Branch type": "Tipo de branch",
  "Changes could not be checked. Anything uncommitted here is discarded.": "Não foi possível verificar as alterações. O que não estiver commitado aqui será descartado.",
  "Choose a branch…": "Escolha um branch…",
  "Choose working copy": "Escolher cópia de trabalho",
  "Clean": "Limpo",
  "Clear queued messages before changing working copies.": "Limpe as mensagens na fila antes de trocar de cópia de trabalho.",
  "Create a branch before deleting this detached worktree": "Crie um branch antes de excluir este worktree destacado",
  "Create a new branch": "Criar um novo branch",
  "Create a worktree to work on another branch in a separate folder.": "Crie um worktree para trabalhar em outro branch em uma pasta separada.",
  "Create worktree": "Criar worktree",
  "Create worktree from {base}": "Criar worktree a partir de {base}",
  "Create worktree…": "Criar worktree…",
  "Created in {path}": "Criado em {path}",
  "Current branch: {branch}": "Branch atual: {branch}",
  "Current checkout": "Checkout atual",
  "Current commit": "Commit atual",
  "Delete worktree": "Excluir worktree",
  "Delete worktree?": "Excluir worktree?",
  "Delete worktree and session": "Excluir worktree e sessão",
  "Delete worktree and sessions": "Excluir worktree e sessões",
  "Detached at {sha}": "Destacado em {sha}",
  "Detached {sha}": "Destacado {sha}",
  "Existing branch": "Branch existente",
  "From {base}": "De {base}",
  "Loading working copies…": "Carregando cópias de trabalho…",
  "Loading worktrees…": "Carregando worktrees…",
  "Locked": "Bloqueado",
  "Manage worktrees…": "Gerenciar worktrees…",
  "Missing": "Ausente",
  "Missing folder": "Pasta ausente",
  "New branch name": "Nome do novo branch",
  "New worktree": "Novo worktree",
  "New worktrees are created in {path}.": "Novos worktrees são criados em {path}.",
  "No additional worktrees": "Nenhum worktree adicional",
  "No matching local branches": "Nenhum branch local correspondente",
  "No matching working copies": "Nenhuma cópia de trabalho correspondente",
  "No repo": "Sem repositório",
  "Open worktree settings": "Abrir configurações de worktree",
  "Project folder": "Pasta do projeto",
  "Refresh worktrees": "Atualizar worktrees",
  "Reveal {name}": "Revelar {name}",
  "Search base branches": "Buscar branches base",
  "Search base branches…": "Buscar branches base…",
  "Search branches and refs…": "Buscar branches e refs…",
  "Search local branches…": "Buscar branches locais…",
  "Search options…": "Buscar opções…",
  "Search working copies": "Buscar cópias de trabalho",
  "Search working copies…": "Buscar cópias de trabalho…",
  "Selected project folder": "Pasta do projeto selecionada",
  "Sessions can share a worktree. Deleting one keeps its sessions by default and discards uncommitted changes. Its branch and commits are kept.": "Sessões podem compartilhar um worktree. Excluir um mantém as sessões por padrão e descarta alterações não commitadas. O branch e os commits são mantidos.",
  "Sessions still use this worktree and could not be deleted.": "Há sessões usando este worktree e elas não puderam ser excluídas.",
  "Some sessions could not be deleted, so the worktree was kept.": "Algumas sessões não puderam ser excluídas, então o worktree foi mantido.",
  "Start from": "Iniciar de",
  "Status unavailable": "Status indisponível",
  "Switch branch in this working copy…": "Trocar branch nesta cópia de trabalho…",
  "The branch is kept.": "O branch é mantido.",
  "The {branch} branch and its commits are kept.": "O branch {branch} e seus commits são mantidos.",
  "This permanently deletes the working copy and everything inside it.": "Isto exclui permanentemente a cópia de trabalho e tudo dentro dela.",
  "This session's worktree was deleted. Select a working copy to continue.": "O worktree desta sessão foi excluído. Selecione uma cópia de trabalho para continuar.",
  "This worktree is being deleted. Select another working copy.": "Este worktree está sendo excluído. Selecione outra cópia de trabalho.",
  "Unlock this worktree in Git first": "Desbloqueie este worktree no Git primeiro",
  "Use an existing local branch": "Usar um branch local existente",
  "Wait for this session to finish before changing working copies.": "Aguarde esta sessão terminar antes de trocar de cópia de trabalho.",
  "Working copies": "Cópias de trabalho",
  "Workspace {label}": "Workspace {label}",
  "Worktree": "Worktree",
  "Worktree base branch": "Branch base do worktree",
  "Worktree settings": "Configurações de worktree",
  "Worktree unavailable": "Worktree indisponível",
  "Existing worktree…": "Worktree existente…",
  "Existing worktrees": "Worktrees existentes",
  "No existing worktrees": "Nenhum worktree existente",
  "Link GitHub issue or PR…": "Vincular issue ou PR do GitHub…",
  "Edit GitHub issue or PR link…": "Editar link de issue ou PR do GitHub…",
  "Link GitHub issue or PR": "Vincular issue ou PR do GitHub",
  "Edit GitHub link": "Editar link do GitHub",
  "Issue or pull request URL": "URL da issue ou pull request",
  "GitHub issue or pull request URL": "URL da issue ou pull request do GitHub",
  "Enter a valid GitHub issue or pull request URL.":
    "Informe uma URL válida de issue ou pull request do GitHub.",
  "Paste the full github.com URL. The linked item will appear on the session card.":
    "Cole a URL completa do github.com. O item vinculado aparece no card da sessão.",
  "Remove link": "Remover link",
  "Update link": "Atualizar link",
  Link: "Vincular",
  Properties: "Propriedades",
  "Branch actions": "Ações do branch",
  Pull: "Pull",
  ...
  "{count} unpublished commits": "{count} commits não publicados",
  "{count} session using this worktree is permanently deleted.": "{count} sessão usando este worktree foi excluída permanentemente.",
  "{count} sessions using this worktree are permanently deleted.": "{count} sessões usando este worktree foram excluídas permanentemente.",
  "{count} session using this worktree is kept. Select a branch or worktree to continue it.": "{count} sessão usando este worktree foi mantida. Selecione um branch ou worktree para continuá-la.",
  "{count} sessions using this worktree are kept. Select a branch or worktree to continue them.": "{count} sessões usando este worktree foram mantidas. Selecione um branch ou worktree para continuá-las.",
  "{count} commit is not on a remote. It stays on the branch.": "{count} commit não está em um remoto. Ele permanece no branch.",
  "{count} commits are not on a remote. They stay on the branch.": "{count} commits não estão em um remoto. Eles permanecem no branch.",
  "Working copy": "Cópia de trabalho",
  "This repo, or a fresh worktree": "Este repositório ou um worktree novo",
  Conversation: "Conversa",
  "New chat, or continue the last run": "Novo chat ou continuar a última execução",
  "Where runs appear in the sidebar": "Onde as execuções aparecem na barra lateral",
  "Missed-run grace": "Tolerância de execuções perdidas",
  "Catch up if a scheduled run was missed":
    "Recuperar se uma execução agendada foi perdida",
  Current: "Atual",
  "Fresh worktree": "Worktree novo",
  "Start fresh": "Começar do zero",
  "Continue last": "Continuar a última",
  "30 minutes": "30 minutos",
  "2 hours": "2 horas",
  "12 hours": "12 horas",
  "24 hours": "24 horas",
  "Do not catch up": "Não recuperar",
  "Draft opened": "Rascunho aberto",
  "Pull request opened": "Pull request aberto",
  "Issue opened": "Issue aberta",
  "Issue created": "Issue criada",
  "Merge request opened": "Merge request aberto",
  "Pull request appeared": "Pull request apareceu",
  "Work item appeared": "Item de trabalho apareceu",
  "No trigger": "Sem gatilho",
  "Remove trigger": "Remover gatilho",
  "Every hour at": "A cada hora às",
  "Every day at": "Todos os dias às",
  "Every weekday at": "Em dias úteis às",
  "Every week on": "Toda semana na",
  Day: "Dia",
  Push: "Push",
  Branch: "Branch",
  "Select a branch": "Selecionar um branch",
  "No branches found": "Nenhum branch encontrado",
  ...
  Trigger: "Gatilho",
  Triggers: "Gatilhos",
  Triggered: "Disparada em",
  Instructions: "Instruções",
  Advanced: "Avançado",
  "Catch-up window for missed runs":
    "Janela de recuperação de execuções perdidas",
  ...
  "Write your own instructions and choose a trigger.":
    "Escreva suas próprias instruções e escolha um gatilho.",
  "Start from scratch": "Começar do zero",
  "Add Trigger": "Adicionar gatilho",
  "Hourly at :{minute}": "A cada hora às :{minute}",
  "{weekday} at {time}": "{weekday} às {time}",

  // Automation templates
  Popular: "Populares",
  "Code Review": "Revisão de código",
  Security: "Segurança",
  "Incidents & Triage": "Incidentes e triagem",
  "Data & Research": "Dados e pesquisa",
  Environment: "Ambiente",
  "Find critical bugs": "Encontrar bugs críticos",
  "Analyze recent commits for high-severity correctness bugs and submit safe fixes":
    "Analise commits recentes em busca de bugs graves de correção e envie correções seguras",
  "Weekdays at 09:00": "Dias úteis às 09:00",
  "Scan codebase for vulnerabilities":
    "Escanear o código em busca de vulnerabilidades",
  "Review the full repository on a schedule and alert on validated high-impact security issues":
    "Revise todo o repositório periodicamente e alerte sobre problemas de segurança validados de alto impacto",
  "Monday at 10:00": "Segunda-feira às 10:00",
  "Generate docs": "Gerar documentação",
  "Create and update developer documentation for recently changed or under-documented code":
    "Crie e atualize documentação de desenvolvedor para código recém-alterado ou pouco documentado",
  "Monday at 09:00": "Segunda-feira às 09:00",
  "Add test coverage": "Adicionar cobertura de testes",
  "Review recent changes and add tests for high-risk logic that lacks adequate coverage":
    "Revise mudanças recentes e adicione testes para lógica de alto risco sem cobertura adequada",
  "Weekdays at 11:00": "Dias úteis às 11:00",
  ...
  "When a pull request is opened, review the diff for bugs, regressions, and missing tests":
    "Quando um pull request for aberto, revise o diff em busca de bugs, regressões e testes faltantes",
  "Review draft PRs": "Revisar PRs em rascunho",
  "Give early feedback when a draft pull request is opened so issues are caught before review":
    "Dê retorno cedo quando um pull request em rascunho for aberto, para que problemas sejam pegos antes da revisão",
  "Audit dependencies": "Auditar dependências",
  "Check lockfiles and manifests for vulnerable, abandoned, or unexpectedly upgraded packages":
    "Verifique lockfiles e manifestos em busca de pacotes vulneráveis, abandonados ou atualizados inesperadamente",
  "Monday at 09:30": "Segunda-feira às 09:30",
  "Scan for secrets": "Escanear segredos",
  "Search the working tree and recent history for committed credentials, tokens, and keys":
    "Procure na árvore de trabalho e no histórico recente credenciais, tokens e chaves commitados",
  "Triage GitHub issues": "Triar issues do GitHub",
  "When a GitHub issue is opened, inspect the repo and add a concrete reproduction or next step":
    "Quando uma issue do GitHub for aberta, inspecione o repositório e adicione uma reprodução concreta ou um próximo passo",
  "Triage new issues": "Triar novas issues",
  "When a Linear issue is created, inspect the repo and add a concrete reproduction or next step":
    "Quando uma issue do Linear for criada, inspecione o repositório e adicione uma reprodução concreta ou um próximo passo",
  "Watch failing checks": "Acompanhar checks com falha",
  "On a weekday morning, run the project's tests and diagnose anything that is already red":
    "Em uma manhã de dia útil, rode os testes do projeto e diagnostique o que já está vermelho",
  "Weekdays at 08:30": "Dias úteis às 08:30",
  "Weekly changelog": "Changelog semanal",
  "Summarize the week's commits into a changelog humans can actually read":
    "Resuma os commits da semana em um changelog que humanos consigam ler",
  "Friday at 16:00": "Sexta-feira às 16:00",
  "Repo health check": "Checagem de saúde do repositório",
  "Inspect the working tree, stale branches, and obvious project-setup drift on a schedule":
    "Inspecione a árvore de trabalho, branches obsoletos e desvios óbvios de configuração do projeto periodicamente",
  "Environment doctor": "Diagnóstico do ambiente",
  "Verify the project still installs and boots from a clean working copy":
    "Verifique se o projeto ainda instala e inicia a partir de uma cópia de trabalho limpa",
  "Next run {day}, {time} {zone}": "Próxima execução {day}, {time} {zone}",
  "Pick an example or start from scratch.":
    "Escolha um exemplo ou comece do zero.",
  "Skills, @file references, and built-in commands work here.":
    "Skills, referências @arquivo e comandos internos funcionam aqui.",

  // Translation sweep (automations module and ported upstream surfaces)
  "Amend Last Commit": "Emendar último commit",
  "Archive session": "Arquivar sessão",
  "Assignment models": "Modelos das tarefas",
  "Attach files or images": "Anexar arquivos ou imagens",
  "Authentication required": "Autenticação necessária",
  "Available banked resets": "Resets acumulados disponíveis",
  "Banked resets": "Resets acumulados",
  "Base brightness of the dark theme. Lower values are darker; zero is true black.": "Brilho base do tema escuro. Valores menores deixam mais escuro; zero é preto absoluto.",
  "Choose chat background": "Escolher fundo do chat",
  "Choose project chat background": "Escolher fundo do chat do projeto",
  "Clean up this session": "Limpar esta sessão",
  "Close all open files with unsaved changes?": "Fechar todos os arquivos abertos com alterações não salvas?",
  "Close all tabs with unsaved files?": "Fechar todas as abas com arquivos não salvos?",
  "Codex CLI installation failed": "Falha na instalação do Codex CLI",
  "Codex CLI installed": "Codex CLI instalado",
  "Collapse project": "Recolher projeto",
  "Command Palette": "Paleta de comandos",
  "Create a reviewable implementation plan before changing files.": "Crie um plano de implementação revisável antes de alterar arquivos.",
  "Dark-mode lightness": "Luminosidade do modo escuro",
  "Delegate subagents": "Delegar subagentes",
  "Delete session": "Excluir sessão",
  "Delete session?": "Excluir sessão?",
  "Diff context": "Contexto do diff",
  "Expand project": "Expandir projeto",
  "Go to File (type > for commands)": "Ir para arquivo (digite > para comandos)",
  "Images": "Imagens",
  "Install Codex CLI": "Instalar Codex CLI",
  "Label": "Rótulo",
  "Linked work item updated": "Item vinculado atualizado",
  "Loading GitHub details": "Carregando detalhes do GitHub",
  "Markdown preview": "Prévia do Markdown",
  "Markdown source": "Fonte do Markdown",
  "Needs attention": "Precisa de atenção",
  "Next month": "Próximo mês",
  "Orchestration plan": "Plano de orquestração",
  "Orchestration proposal": "Proposta de orquestração",
  "Orchestrator": "Orquestrador",
  "Parallel workers": "Workers paralelos",
  "Place this session in an existing or new sidebar folder.": "Coloque esta sessão em uma pasta existente ou nova da barra lateral.",
  "Previous month": "Mês anterior",
  "Search assignment models": "Buscar modelos das tarefas",
  "Search models or harnesses…": "Buscar modelos ou harnesses…",
  "Summarize older conversation context to free space.": "Resuma o contexto mais antigo da conversa para liberar espaço.",
  "System default": "Padrão do sistema",
  "This only affects dark mode. Your dark-mode value is preserved.": "Isto afeta apenas o modo escuro. Seu valor do modo escuro é preservado.",
  "Turn metrics": "Métricas do turno",
  "Turn off Orchestrator mode": "Desativar modo Orquestrador",
  "Turn plan mode on": "Ativar modo de planejamento",
  "Update available": "Atualização disponível",
  "What parallel workers means": "O que significa workers paralelos",
