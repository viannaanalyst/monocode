...
import { orderedHarnesses } from "../features/sessions/model/providerOrder";
import {
...
import { TooltipLayer } from "../features/sessions/ui/Tooltip";
...
import { RightDockTypeBar, type RightDockType } from "../features/sessions/ui/RightDockTypeBar";
import {
  RightPanelPicker,
  RightPanelTypeMenu,
} from "../features/sessions/ui/RightPanelPicker";
...
import { isDangerousCommand } from "../features/sessions/model/dangerousCommands";
import { notifyDirsChanged } from "../features/files/model/fileTree";
import { nudgeWatchedFiles } from "../features/files/model/fileWatch";
...
import { composeTurnPrompt, goalCompleted, type SessionGoal } from "../features/sessions/model/goal";
...
} from "../features/sessions/model/sessionExport";
import { saveSessionExport } from "../features/sessions/model/sessionExportIo";
...
import { KanbanView } from "../features/sessions/ui/KanbanView";
...
import { TRANSCRIPT_FIND_EVENT } from "../features/sessions/model/transcriptFind";
...
export default function App({
  ...
  const openReminderSession = useCallback(
    async (sessionId: string) => {
      ...
      if (!session)
        throw new Error(t("This conversation is no longer available."));
      setSearchViewOpen(false);
      setInboxViewOpen(false);
      setNotesViewOpen(false);
      setKanbanViewOpen(false);
